...
@section('content')
    ...
    <script type="text/javascript">
        function add(){
            ...
            var nexthtml = '<tr id="'+nextid+'" class="add"><th><input type="text" class="input-sm"/></th> <th><input type="text" class="input-sm"/></th> <th><textarea rows="10"></textarea></th> <th><input type="file"></th> <th><button type="button" class="btn btn-default" onclick="deleteEle(this);">删除</button></th> </tr>'
            if(nextid == 1){
